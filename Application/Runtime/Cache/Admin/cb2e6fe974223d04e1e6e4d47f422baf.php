            ...
            <div class="panel-body">
              <div class="table-responsive">
                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                  ...
                  <tbody>
                  <tr class="odd gradeX">
                    <td><?php echo ($detail_data["order_no"]); ?></td>
                    <td><?php echo ($detail_data["order_place"]); ?></td>
                    <td><?php echo ($detail_data["consignee_name"]); ?></td>
                    <td class="center"><?php echo ($detail_data["total_amount"]); ?></td>
                    <td class="center"><?php echo ($detail_data["amount_payable"]); ?></td>
                    <td>
                      <?php if($detail_data["pay_stauts"] == 1): ?>已付款
                        <?php else: ?>
                        未付款<?php endif; ?>
                      &nbsp;&nbsp;&nbsp;
                      <?php if($detail_data["delivery_status"] == 1): ?>已发货
                        <?php else: ?>
                        未发货<?php endif; ?>
                      &nbsp;&nbsp;&nbsp;
                      <?php if($detail_data["confirm_status"] == 1): ?>已确认
                        <?php else: ?>
                        未确认<?php endif; ?>
                    </td>
                  </tr>
                ...
                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                  ...
                  <tr class="odd gradeX">
                    <td><?php echo ($detail_data["consignee_name"]); ?></td>
                    <td><?php echo ($detail_data["distribution"]); ?></td>
                    <td><?php echo ($detail_data["order_place_time"]); ?></td>
                    <td class="center"><?php echo ($detail_data["pay_time"]); ?></td>
                    <td class="center"><?php echo ($detail_data["delivery_time"]); ?></td>
                    <td class="center"><?php echo ($detail_data["order_from"]); ?></td>
                  </tr>
                  </tbody>
                </table>
                ...
                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                  ...
                  <tr class="odd gradeX">
                    <td><?php echo ($detail_data["consignee_name"]); ?></td>
                    <td><?php echo ($detail_data["address"]); ?></td>
                    <td><?php echo ($detail_data["phone"]); ?></td>
                  </tr>
                  </tbody>
                </table>
                ...
                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                  ...
                  <tbody>
                  <tr class="odd gradeX">
                    <td><?php echo ($detail_data["goods_name"]); ?></td>
                    <td><?php echo ($detail_data["goods_no"]); ?></td>
                    <td><?php echo ($detail_data["goods_item_no"]); ?></td>
                    <td><?php echo ($detail_data["goods_price"]); ?></td>
                    <td><?php echo ($detail_data["goods_count"]); ?></td>
                    <td><?php echo ($detail_data["goods_count"]); ?></td>
                    <td><?php echo $detail_data['goods_price']*$detail_data['goods_count'];?></td>
